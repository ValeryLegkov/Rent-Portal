...
export const PropertyDetails = ({ property }: { property: PropertiesType }) => {
  return (
    <>
      <main>
        <div className="bg-white p-6 rounded-lg shadow-md text-center md:text-left">
          ...
          <div className="text-gray-500 mb-4 flex align-middle justify-center md:justify-start">
            <FaMapMarker className="text-rose-500 mr-2" />
          ...
          <h3 className="text-lg font-bold my-6 bg-gray-500 text-white p-2">
            Rates & Options
          </h3>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md mt-6">
          ...
          <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 list-none">
            {property.amenities.map((amenities, index) => (
              <li key={index}>
                <FaCheck className="inline-block text-lime-500 mr-2" />{" "}
                {amenities}
              </li>
            ))}
          </ul>
